...
<div id="tab-pessoal" class="col s12">
	<!-- 
	<div class="col l2 m2">
	...
	<c:import url="/WEB-INF/jsp/cadastro/menu-pessoal.jsp" />
	...
	<div id="dados-pessoais" class="section scrollspy">
		...
		<div class="row">
			...
			<div class="input-field col s12 m6">
				<input id="celular" type="text" class="input-celular" name="pessoa.celular" value="${pessoa.celular}">
	...
	<div id="endereco" class="section scrollspy">
		...
		<div class="row">
			<div class="input-field col s12 m4">
				<input id="end-telefone" type="text" class="input-telefone" name="pessoa.endereco.telefone" value="${pessoa.endereco.telefone}">
	...
	<div id="fromacao" class="section scrollspy">
		<h3>Escolaridade e Profissão</h3>
		<div class="row">
			<div class="input-field col s6 m6">
				<select id="escolaridade" name="pessoa.formacao.escolaridade" class="required-field">
					<option value="" disabled selected>Escolaridade</option>
				</select>
				<label for="escolaridade">Escolaridade</label>
			</div>
			<div class="input-field col s6 m6">
				<select id="instituicao-tipo" name="pessoa.formacao.tipoInstituicao" class="required-field">
					<option value="" disabled selected>Tipo da Instituição</option>
				</select>
				<label for="instituicao-tipo">Tipo da Instituição</label>
			</div>
		</div>
	</div>
